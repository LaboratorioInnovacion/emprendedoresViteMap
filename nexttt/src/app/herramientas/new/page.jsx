...
function HerramientasDesktop({ form, handleChange, handleSubmit, error, origenTipoOptions, tipoBeneficiarioOptions, tipoHerramientaEmprendimientoOptions, tipoHerramientaEmprendedorOptions, herramientas, loading, handleDelete }) {
  ...
  <h1 className="mb-2 text-center text-gray-600 dark:text-gray-300">Herramientas de Apoyo</h1>
  <h2 className="mb-4 text-center text-gray-600 dark:text-gray-300">Agregar nueva herramienta</h2>
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <label className="flex flex-col">
            <span className="mb-1 text-gray-600 dark:text-gray-300">Nombre:</span>
            <input name="nombre" value={form.nombre} onChange={handleChange} placeholder="Nombre" required className="input w-full" />
          </label>
          <label className="flex flex-col">
            <span className="mb-1 text-gray-600 dark:text-gray-300">Origen Tipo:</span>
          ...
          <label className="flex flex-col">
            <span className="mb-1 text-gray-600 dark:text-gray-300">Origen Organismo:</span>
          ...
          <label className="flex flex-col">
            <span className="mb-1 text-gray-600 dark:text-gray-300">Tipo Beneficiario:</span>
          ...
          <label className="flex flex-col">
            <span className="mb-1 text-gray-600 dark:text-gray-300">Tipo Herramienta Emprendimiento:</span>
          ...
          <label className="flex flex-col">
            <span className="mb-1 text-gray-600 dark:text-gray-300">Tipo Herramienta Emprendedor:</span>
          ...
          <div className="flex gap-4">
            <label className="flex flex-col w-full">
              <span className="mb-1 text-gray-600 dark:text-gray-300">Monto Total:</span>
            ...
            <label className="flex flex-col w-full">
              <span className="mb-1 text-gray-600 dark:text-gray-300">Monto por Beneficiario:</span>
          ...
          <div className="flex gap-4">
            <label className="flex flex-col w-full">
              <span className="mb-1 text-gray-600 dark:text-gray-300">Fecha Inicio Vigencia:</span>
            ...
            <label className="flex flex-col w-full">
              <span className="mb-1 text-gray-600 dark:text-gray-300">Fecha Fin Vigencia:</span>
          ...
          <label className="flex flex-col">
            <span className="mb-1 text-gray-600 dark:text-gray-300">Cupo:</span>
            <input name="cupo" value={form.cupo} onChange={handleChange} placeholder="Cupo" type="number" className="input w-full" />
          </label>
          <label className="flex flex-col">
            <span className="mb-1 text-gray-600 dark:text-gray-300">Observaciones:</span>
      ...
      <div className="card">
  <h2 className="mb-4 text-center text-gray-600 dark:text-gray-300">Herramientas registradas</h2>
...
function HerramientasMobile({ form, handleChange, handleSubmit, error, origenTipoOptions, tipoBeneficiarioOptions, tipoHerramientaEmprendimientoOptions, tipoHerramientaEmprendedorOptions, herramientas, loading, handleDelete }) {
  ...
  <h1 className="mb-2 text-center text-lg text-gray-600 dark:text-gray-300">Herramientas de Apoyo</h1>
  <h2 className="mb-4 text-center text-gray-600 dark:text-gray-300 text-base">Agregar nueva herramienta</h2>
        <form onSubmit={handleSubmit} className="flex flex-col gap-2">
          <label className="flex flex-col">
            <span className="mb-1 text-xs text-gray-600 dark:text-gray-300">Nombre:</span>
            <input name="nombre" value={form.nombre} onChange={handleChange} placeholder="Nombre" required className="input w-full text-sm" />
          </label>
          <label className="flex flex-col">
            <span className="mb-1 text-xs text-gray-600 dark:text-gray-300">Origen Tipo:</span>
          ...
          <label className="flex flex-col">
            <span className="mb-1 text-xs text-gray-600 dark:text-gray-300">Origen Organismo:</span>
          ...
          <label className="flex flex-col">
            <span className="mb-1 text-xs text-gray-600 dark:text-gray-300">Tipo Beneficiario:</span>
          ...
          <label className="flex flex-col">
            <span className="mb-1 text-xs text-gray-600 dark:text-gray-300">Tipo Herramienta Emprendimiento:</span>
          ...
          <label className="flex flex-col">
            <span className="mb-1 text-xs text-gray-600 dark:text-gray-300">Tipo Herramienta Emprendedor:</span>
          ...
          <label className="flex flex-col">
            <span className="mb-1 text-xs text-gray-600 dark:text-gray-300">Monto Total:</span>
          ...
          <label className="flex flex-col">
            <span className="mb-1 text-xs text-gray-600 dark:text-gray-300">Monto por Beneficiario:</span>
          ...
          <label className="flex flex-col">
            <span className="mb-1 text-xs text-gray-600 dark:text-gray-300">Fecha Inicio Vigencia:</span>
          ...
          <label className="flex flex-col">
            <span className="mb-1 text-xs text-gray-600 dark:text-gray-300">Fecha Fin Vigencia:</span>
          ...
          <label className="flex flex-col">
            <span className="mb-1 text-xs text-gray-600 dark:text-gray-300">Cupo:</span>
            <input name="cupo" value={form.cupo} onChange={handleChange} placeholder="Cupo" type="number" className="input w-full text-sm" />
          </label>
          <label className="flex flex-col">
            <span className="mb-1 text-xs text-gray-600 dark:text-gray-300">Observaciones:</span>
      ...
      <div className="card">
  <h2 className="mb-2 text-center text-gray-600 dark:text-gray-300 text-base">Herramientas registradas</h2>
  {loading ? <p className="text-center text-sm text-gray-600 dark:text-gray-300">Cargando...</p> : (
          <div>
            {herramientas.map((h) => (
              <div key={h.id} className="mb-2 p-2 border-b last:border-b-0 flex flex-col gap-1">
                <div className="flex justify-between text-xs font-semibold text-gray-600 dark:text-gray-300"><span>ID:</span> <span>{h.id}</span></div>
                <div className="flex justify-between text-xs text-gray-600 dark:text-gray-300"><span>Nombre:</span> <span>{h.nombre}</span></div>
                <div className="flex justify-between text-xs text-gray-600 dark:text-gray-300"><span>Origen Tipo:</span> <span>{Array.isArray(h.origenTipo) ? h.origenTipo.join(', ') : h.origenTipo}</span></div>
                <div className="flex justify-between text-xs text-gray-600 dark:text-gray-300"><span>Organismo:</span> <span>{h.origenOrganismo}</span></div>
                <div className="flex justify-between text-xs text-gray-600 dark:text-gray-300"><span>Tipo Beneficiario:</span> <span>{h.tipoBeneficiario}</span></div>
                <div className="flex justify-between text-xs text-gray-600 dark:text-gray-300"><span>Cupo:</span> <span>{h.cupo}</span></div>
