...
function NuevoEmprendimientoPage() {
  ...
  // MapSelector importado de forma estática arriba
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-2xl mx-auto p-6 space-y-4">
      ...
      <label>
        <input
          type="checkbox"
          name="inscripcionArca"
          checked={form.inscripcionArca}
          onChange={handleChange}
        />{" "}
        Inscripción Arca
      </label>
      ...
      <input
        ...
        value={form.cantidadPersonal}
        onChange={handleChange}
        placeholder="Cantidad Personal"
        className="input w-full"
      />
      <p>Modo Incorporación Personal</p>
      <input
        name="modoIncorporacionPersonal"
        value={form.modoIncorporacionPersonal}
        onChange={handleChange}
        placeholder="Modo Incorporación Personal (separado por coma)"
        className="input w-full"
      />
      ...
      <label>
        <input
          ...
          checked={form.requiereCapacitacion}
          onChange={handleChange}
        />{" "}
      ...
      <input
        name="tiposCapacitacion"
        value={form.tiposCapacitacion}
        onChange={handleChange}
        placeholder="Tipos Capacitacion (separado por coma)"
        className="input w-full"
      />
      <p>Otros Tipos Capacitacion</p>
      <input
        name="otrosTiposCapacitacion"
        value={form.otrosTiposCapacitacion}
        onChange={handleChange}
        placeholder="Otros Tipos Capacitacion"
        className="input w-full"
      />
      <label>
        <input
          type="checkbox"
          name="requiereConsultoria"
          checked={form.requiereConsultoria}
          onChange={handleChange}
        />{" "}
        Requiere Consultoria
      </label>
      <p>Tipos Consultoria</p>
      <input
        name="tiposConsultoria"
        value={form.tiposConsultoria}
        onChange={handleChange}
        placeholder="Tipos Consultoria (separado por coma)"
        className="input w-full"
      />
      <p>Otros Tipos Consultoria</p>
      <input
        name="otrosTiposConsultoria"
        value={form.otrosTiposConsultoria}
        onChange={handleChange}
        placeholder="Otros Tipos Consultoria"
        className="input w-full"
      />
      <label>
        <input
          ...
          checked={form.requiereHerramientasTecno}
          onChange={handleChange}
        />{" "}
        Requiere Herramientas Tecno
      </label>
      <p>Tipos Herramientas Tecno</p>
      <input
        name="tiposHerramientasTecno"
        value={form.tiposHerramientasTecno}
        onChange={handleChange}
        placeholder="Tipos Herramientas Tecno (separado por coma)"
        className="input w-full"
      />
      <p>Otras Herramientas Tecno</p>
      <input
        name="otrasHerramientasTecno"
        value={form.otrasHerramientasTecno}
        onChange={handleChange}
        placeholder="Otras Herramientas Tecno"
        className="input w-full"
      />
      <label>
        <input
          type="checkbox"
          name="usaRedesSociales"
          checked={form.usaRedesSociales}
          onChange={handleChange}
        />{" "}
        Usa Redes Sociales
      </label>
      <input
        ...
        value={form.tiposRedesSociales}
        onChange={handleChange}
        placeholder="Tipos Redes Sociales (separado por coma)"
        className="input w-full"
      />
      <label>
        <input
          type="checkbox"
          name="usaMediosPagoElectronicos"
          checked={form.usaMediosPagoElectronicos}
          onChange={handleChange}
        />{" "}
        Usa Medios Pago Electrónicos
      </label>
      <p>Canales Comercialización</p>
      <input
        name="canalesComercializacion"
        value={form.canalesComercializacion}
        onChange={handleChange}
        placeholder="Canales Comercialización (separado por coma)"
        className="input w-full"
      />
      <p>Otros Canales Comercialización</p>
      <input
        name="otrosCanalesComercializacion"
        value={form.otrosCanalesComercializacion}
        onChange={handleChange}
        placeholder="Otros Canales Comercialización"
        className="input w-full"
      />
      <label>
        <input
          type="checkbox"
          name="poseeSucursales"
          checked={form.poseeSucursales}
          onChange={handleChange}
        />{" "}
        Posee Sucursales
      </label>
      ...
      <input
        ...
        onChange={handleChange}
        placeholder="Cantidad Sucursales"
        className="input w-full"
      />
      <p>Ubicación Sucursales</p>
      <input
        name="ubicacionSucursales"
        value={form.ubicacionSucursales}
        onChange={handleChange}
        placeholder="Ubicación Sucursales (separado por coma)"
        className="input w-full"
      />
      <label>
        <input
          type="checkbox"
          name="planeaAbrirSucursal"
          checked={form.planeaAbrirSucursal}
          onChange={handleChange}
        />{" "}
        Planea Abrir Sucursal
      </label>
