...
export default function EditarEmprendedorOtrosPage({ params }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setTimeout(() => router.push("/otros"), 1200);
      } else {
  ...
  <h2 className="text-2xl font-bold text-center text-gray-800 dark:text-gray-200 mb-4">Editar emprendedor otros</h2>
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4">
            {/* ...campos igual que el formulario original... */}
            <div className="flex flex-col gap-1">
              <label htmlFor="nombre" className="text-xs text-gray-800 dark:text-gray-200">Nombre</label>
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="apellido" className="text-xs text-gray-800 dark:text-gray-200">Apellido</label>
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="dni" className="text-xs text-gray-800 dark:text-gray-200">DNI</label>
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="cuil" className="text-xs text-gray-800 dark:text-gray-200">CUIL/CUIT</label>
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="fechaNacimiento" className="text-xs text-gray-800 dark:text-gray-200">Fecha de nacimiento</label>
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="genero" className="text-xs text-gray-800 dark:text-gray-200">Género</label>
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="paisOrigen" className="text-xs text-gray-800 dark:text-gray-200">País de origen</label>
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="ciudadOrigen" className="text-xs text-gray-800 dark:text-gray-200">Ciudad de origen</label>
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="nivelEstudios" className="text-xs text-gray-800 dark:text-gray-200">Nivel de estudios</label>
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="motivacionEmprender" className="text-xs text-gray-800 dark:text-gray-200">Motivación para emprender</label>
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="departamento" className="text-xs text-gray-800 dark:text-gray-200">Departamento/localidad</label>
              <select
                id="departamento"
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="direccion" className="text-xs text-gray-800 dark:text-gray-200">Dirección</label>
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="telefono" className="text-xs text-gray-800 dark:text-gray-200">Teléfono</label>
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="cantidadEmprendimientos" className="text-xs text-gray-800 dark:text-gray-200">Cantidad de emprendimientos</label>
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <label htmlFor="poseeOtrosSustentos" className="text-xs text-gray-800 dark:text-gray-200">¿Posee otros sustentos?</label>
              <span className="text-xs">{form.poseeOtrosSustentos ? "Sí" : "No"}</span>
            </div>
            <div className="flex flex-col gap-1 col-span-1 sm:col-span-2">
              <label htmlFor="tiposSustento" className="text-xs text-gray-800 dark:text-gray-200">Tipos de sustento (separados por coma)</label>
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <label htmlFor="tieneDependientesEconomicos" className="text-xs text-gray-800 dark:text-gray-200">¿Tiene dependientes económicos?</label>
          ...
          {/* Imagen DNI */}
          <div className="flex flex-col gap-1 col-span-1 sm:col-span-2">
            <label htmlFor="fotoDni" className="text-xs text-gray-800 dark:text-gray-200">Foto DNI (opcional)</label>
