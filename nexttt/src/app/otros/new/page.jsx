...
export default function CrearEmprendedorOtrosPage() {
		...
		return (
			<div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
				<div className="w-full max-w-6xl p-4 sm:p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 flex flex-col gap-8">
					<h2 className="text-2xl font-bold text-center text-gray-800 dark:text-gray-200 mb-4">Crear nuevo emprendedor otros</h2>
