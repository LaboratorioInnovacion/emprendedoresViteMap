...
export async function PUT(req, context) {
  try {
    ...
    if (updateData.ubicacion) {
      let ubicacionStr = typeof updateData.ubicacion === 'object' ? JSON.stringify(updateData.ubicacion) : updateData.ubicacion;
      updateData.ubicacion = { set: Buffer.from(ubicacionStr) };
    }
