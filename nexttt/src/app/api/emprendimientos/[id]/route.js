...
export async function PUT(req, context) {
  try {
    ...
    const allowedFields = [
      "nombre", "descripcion", "sector", "estado", "fechaInicio", "ubicacion",
      "direccion", "telefono", "web", "redes", "logo", "fotoPerfil", "cuil",
      "cantidadEmpleados", "facturacion", "tipo", "rubro", "subrubro", "observaciones"
    ];
    const updateData = {};
    ...
    if (updateData.ubicacion && typeof updateData.ubicacion === "object") {
      updateData.ubicacion = { set: Buffer.from(JSON.stringify(updateData.ubicacion)) };
    }
