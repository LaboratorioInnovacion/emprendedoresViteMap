...
const Page = () => {
  ...
  <h1 className="text-2xl font-bold mb-6 text-gray-600 dark:text-gray-300">Nueva Capacitación</h1>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block font-semibold mb-1 text-gray-600 dark:text-gray-300">Nombre *</label>
            <input type="text" name="nombre" value={form.nombre} onChange={handleChange} required className="input input-bordered w-full" />
          </div>
          <div>
            <label className="block font-semibold mb-1 text-gray-600 dark:text-gray-300">Tipo <span className="text-xs text-gray-600 dark:text-gray-300">(separa por coma)</span></label>
          ...
          <div>
            <label className="block font-semibold mb-1 text-gray-600 dark:text-gray-300">Organismo *</label>
            <input type="text" name="organismo" value={form.organismo} onChange={handleChange} required className="input input-bordered w-full" />
          </div>
          <div>
            <label className="block font-semibold mb-1 text-gray-600 dark:text-gray-300">Modalidad</label>
          ...
          <div>
            <label className="block font-semibold mb-1 text-gray-600 dark:text-gray-300">Descripción</label>
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              <label className="block font-semibold mb-1 text-gray-600 dark:text-gray-300">Fecha Inicio</label>
              <input type="date" name="fechaInicio" value={form.fechaInicio} onChange={handleChange} className="input input-bordered w-full" />
            </div>
            <div className="flex-1">
              <label className="block font-semibold mb-1 text-gray-600 dark:text-gray-300">Fecha Fin</label>
              <input type="date" name="fechaFin" value={form.fechaFin} onChange={handleChange} className="input input-bordered w-full" />
            </div>
          </div>
          <div>
            <label className="block font-semibold mb-1 text-gray-600 dark:text-gray-300">Cupo</label>
            <input type="number" name="cupo" value={form.cupo} onChange={handleChange} min="0" className="input input-bordered w-full" />
          </div>
          <div>
            <label className="block font-semibold mb-1 text-gray-600 dark:text-gray-300">Observaciones</label>
