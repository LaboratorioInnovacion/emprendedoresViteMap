      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex-1">
          <div className="flex justify-between items-start">
            <div>
              <h3 className="text-lg text-gray-800 dark:text-gray-200 font-bold mb-1">{business.name}</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">{business.description}</p>
            </div>
