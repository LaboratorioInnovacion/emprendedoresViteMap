...
export const businesses: Business[] = [
  ...
  },
  {
    ...
    description:
      "Sustainable organic food marketplace supporting local farmers.",
    type: "Gastronomía",
    ...
    status: "active",
    imageUrl:
      "https://images.pexels.com/photos/3184192/pexels-photo-3184192.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
  ...
  },
  {
    ...
    status: "active",
    imageUrl:
      "https://images.pexels.com/photos/4386464/pexels-photo-4386464.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
  ...
  },
  {
    ...
    description:
      "Holistic wellness center offering massage and relaxation services.",
    type: "Servicios",
...
export const dashboardStats: DashboardStat[] = [
  ...
  },
  {
    ...
    title: "Tech Ventures",
    value: getBusinessTypeCount("Tecnología"),
    change: 5.1,
    trend: "up",
    icon: "TrendingUp",
  },
  {
    id: "retail-locations",
    title: "Gastronomía",
    value: getBusinessTypeCount("Gastronomía"),
    change: -2.3,
    trend: "down",
...
//     id: "technology-ventures",
//     title: "Tech Ventures",
//     value: getBusinessTypeCount("tecnologia"),
//     change: 5.1,
//     trend: "up",
//     icon: "TrendingUp",
//   },
...
//     value: getBusinessTypeCount("minorista"),
//     change: -2.3,
//     trend: "down",
//     icon: "BadgeDollarSign",
//   },
...
//     0
//   );
//   const totalLng = businesses.reduce(
//     (sum, business) => sum + business.location.lng,
//     0
//   );

//   return [totalLat / businesses.length, totalLng / businesses.length];
// };
