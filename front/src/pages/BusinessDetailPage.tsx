  ...
  if (!business) {
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6">The business you are looking for doesn't exist or has been removed.</p>
        <button 
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <div className="flex items-center mt-1">
              <span className="badge badge-secondary capitalize mr-2">{business.type}</span>
